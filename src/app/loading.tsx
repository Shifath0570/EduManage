            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="relative mb-8">
                <div className="relative">
                  {/* Outer Ring */}
                  <div className="w-32 h-32 rounded-full border-4 border-emerald-400/20 animate-pulse"></div>
                  
                  {/* Spinning Ring */}
                  <div className="absolute inset-0 w-32 h-32 rounded-full border-4 border-t-emerald-400 border-r-transparent border-b-transparent border-l-transparent animate-spin"></div>
                  
                  {/* Inner Icon */}
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="p-4 bg-white/10 rounded-full backdrop-blur-sm border border-white/20">
                      <GraduationCap className="w-12 h-12 text-emerald-300 animate-pulse" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full max-w-sm">
                <div className="relative h-2 bg-white/10 rounded-full overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-emerald-400 via-green-400 to-teal-400 rounded-full animate-loading-bar"></div>
                </div>
                <div className="flex justify-between mt-2">
                  <span className="text-emerald-300/50 text-xs">Loading...</span>
                  <span className="text-emerald-300/50 text-xs">Please wait</span>
                </div>
              </div>
