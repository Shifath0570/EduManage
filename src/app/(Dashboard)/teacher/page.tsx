      ...
      <div className="w-full max-w-xl mx-auto my-12 p-6 bg-white border border-rose-100 rounded-xl shadow-sm text-center space-y-4">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            {error || sessionError?.message || 'Teacher information could not be found.'}
          </p>
        </div>
    ...
    <div className="mx-auto w-[90%] px-6 py-10 space-y-6 font-sans text-slate-800">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex items-center gap-3">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-slate-900">{teacher.fullName} Profile</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm flex flex-col items-center text-center">
          <div className="relative w-32 h-32 rounded-full overflow-hidden bg-slate-100 border-4 border-slate-50 shadow-inner mb-4">
            {!imgError && teacher.profilePhoto ? (
              <Image
                ...
                alt={teacher.fullName || 'Teacher Photo'}
                fill
                sizes="128px"
          ...
          <h2 className="text-xl font-bold text-slate-900">{teacher.fullName || 'N/A'}</h2>
          <p className="text-xs text-indigo-600 font-semibold mt-0.5">
            {teacher.subjectSpecialization ? `${teacher.subjectSpecialization} Teacher` : 'Teacher'}
          </p>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-slate-50 p-4 rounded-lg border border-slate-100">
                ...
                <div className="text-sm font-bold text-slate-800">
                  {teacher.city
                    ? `${teacher.city}${teacher.stateProvince ? `, ${teacher.stateProvince}` : ''}`
                    : '-'}
                </div>
              </div>
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-slate-50 p-4 rounded-lg border border-slate-100">
                <div className="flex items-center gap-2 text-xs font-medium text-slate-500 mb-1">
                  <UserIcon size={14} /> Guardian Name
                </div>
