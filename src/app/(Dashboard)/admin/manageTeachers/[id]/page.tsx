  ...
  if (loading) {
    return (
      <div className="w-full min-h-[500px] flex flex-col items-center justify-center space-y-3 text-slate-500 bg-slate-50/50">
        ...
        <p className="text-sm font-semibold tracking-wide text-slate-600">Loading teacher details...</p>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-slate-50/50 py-12 px-4 flex items-center justify-center">
        <div className="w-full max-w-md p-6 bg-white border border-rose-100 rounded-2xl shadow-sm text-center space-y-4">
          ...
          <div>
            <h2 className="text-lg font-bold text-slate-900">Failed to Load Teacher</h2>
            <p className="text-xs text-slate-500 mt-1">{error || 'Teacher information could not be found.'}</p>
          </div>
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">Teacher Profile</h1>
              <p className="text-xs sm:text-sm font-medium text-slate-500">Employee ID: {teacher.employeeId}</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm flex flex-col items-center text-center">
            ...
            <div className="mt-3 flex items-center gap-2 flex-wrap justify-center">
              <span className="px-3 py-1 bg-indigo-50 text-indigo-700 border border-indigo-200/60 rounded-full text-xs font-semibold">
                ID: {teacher.employeeId}
              </span>
              ...
              {teacher.bloodGroup && (
                <span className="px-2.5 py-1 bg-rose-50 text-rose-600 border border-rose-200/60 rounded-full text-xs font-semibold flex items-center gap-1">
                  <Droplet size={12} /> {teacher.bloodGroup}
                </span>
              )}
            </div>
            ...
            <div className="w-full space-y-3 text-left text-xs sm:text-sm">
              ...
              <div className="flex items-center gap-3 text-slate-600 bg-slate-50/60 p-2.5 rounded-xl border border-slate-100">
                ...
                <span className="font-medium">DOB: {formatDate(teacher.dateOfBirth)}</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-slate-50/80 p-4 rounded-xl border border-slate-200/60">
                  <div className="flex items-center gap-2 text-xs font-semibold text-slate-500 mb-1">
                    <BookOpenCheck size={14} className="text-indigo-500" /> Specialization
                  </div>
                  <div className="text-sm font-bold text-slate-800">{teacher.subjectSpecialization || '-'}</div>
                </div>
                ...
                <div className="bg-slate-50/80 p-4 rounded-xl border border-slate-200/60">
                  <div className="flex items-center gap-2 text-xs font-semibold text-slate-500 mb-1">
                    <Award size={14} className="text-indigo-500" /> Qualification
                  </div>
                  <div className="text-sm font-bold text-slate-800">{teacher.qualifications || '-'}</div>
                </div>
                ...
                <div className="bg-slate-50/80 p-4 rounded-xl border border-slate-200/60">
                  <div className="flex items-center gap-2 text-xs font-semibold text-slate-500 mb-1">
                    <IdCard size={14} className="text-indigo-500" /> Experience
                  </div>
                  <div className="text-sm font-bold text-slate-800">
                    {teacher.experienceYears} {teacher.experienceYears === 1 ? 'Year' : 'Years'}
                  </div>
                ...
                <div className="bg-slate-50/80 p-4 rounded-xl border border-slate-200/60">
                  <div className="flex items-center gap-2 text-xs font-semibold text-slate-500 mb-1">
                    <Calendar size={14} className="text-indigo-500" /> Joining Date
                  </div>
                  <div className="text-sm font-bold text-slate-800">{formatDate(teacher.joiningDate)}</div>
                </div>
              </div>
            ...
            <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-slate-50/80 p-4 rounded-xl border border-slate-200/60 sm:col-span-2">
                  <div className="flex items-center gap-2 text-xs font-semibold text-slate-500 mb-1">
                    <Building size={14} className="text-indigo-500" /> Street Address
                  </div>
                  <div className="text-sm font-bold text-slate-800">{teacher.address || '-'}</div>
                </div>
                ...
                <div className="bg-slate-50/80 p-4 rounded-xl border border-slate-200/60">
                  <div className="flex items-center gap-2 text-xs font-semibold text-slate-500 mb-1">
                    <MapPin size={14} className="text-indigo-500" /> City / State
                  </div>
                  <div className="text-sm font-bold text-slate-800">
                    {teacher.city ? `${teacher.city}, ${teacher.stateProvince}` : '-'}
                  </div>
                ...
                <div className="bg-slate-50/80 p-4 rounded-xl border border-slate-200/60">
                  <div className="flex items-center gap-2 text-xs font-semibold text-slate-500 mb-1">
                    <IdCard size={14} className="text-indigo-500" /> Postal Code
                  </div>
                  <div className="text-sm font-bold text-slate-800">{teacher.postCode || '-'}</div>
                </div>
              </div>
            ...
            <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="bg-slate-50/80 p-4 rounded-xl border border-slate-200/60">
                  <div className="flex items-center gap-2 text-xs font-semibold text-slate-500 mb-1">
                    <Phone size={14} className="text-rose-500" /> Emergency Contact
                  </div>
                  <div className="text-sm font-bold text-rose-600">{teacher.emergencyContact || '-'}</div>
                </div>
              </div>
