                ...
                <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-0">
                    ...
                    <div className="flex items-center gap-4 rounded-full bg-blue-50 px-4 py-2">
                        ...
                        <Link
                            ...
                            className="inline-flex items-center gap-2 rounded-full bg-blue-600 px-4 py-1.5 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-200"
                        >
