...
export default function Navbar() {
  ...
  // Resolve the role-based dashboard URL
  const userRole = user?.role || "student";
  const dashboardHref = dashboardLinks[userRole] || "/student";

  // Dynamically add role-based Dashboard link when authenticated
  ...
  const handleLogout = async () => {
    ...
    // Fallback redirect in case auth-client handles routing differently
    router.push("/");
  };
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          {isPending ? (
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <Avatar className="h-8 w-8 ring-2 ring-cyan-400/50" size="sm">
