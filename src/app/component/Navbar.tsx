...
//         {/* Mobile: Menu Toggle (Left) | Desktop: Brand Logo (Left) */}
...
//           {/* Desktop Only Logo */}
//           <Link href="/" className="hidden lg:flex items-center gap-2.5 focus:outline-none">
...
//         {/* Right Section */}
//         <div className="flex items-center gap-3">
//           {/* Mobile Only: Brand Logo on the Right */}
//           <Link href="/" className="flex lg:hidden items-center gap-2 focus:outline-none">
//             <div className="flex flex-col text-right">
//               <span className="text-lg font-bold leading-none tracking-tight text-white">
//                 EduManage
//               </span>
//               <span className="text-[9px] font-medium leading-tight text-blue-200/80">
//                 Portal
//               </span>
//             </div>
//             <div className="relative flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-b from-blue-400 to-blue-600 text-white shadow-sm">
//               <Shield className="h-7 w-7 text-blue-400 fill-blue-500 absolute" />
//               <BookOpen className="h-3.5 w-3.5 text-white relative z-10 stroke-[2.5]" />
//             </div>
//           </Link>
