...
// import { BookOpen, Eye, EyeOff, Sparkles, ArrowRight, KeyRound, ArrowLeft } from "lucide-react";
// // import { signIn, forgetPassword } from "@/app/lib/auth-client";
...
//       {resetSuccess && (
//         <div className="mt-5 rounded-2xl border border-emerald-200/80 bg-emerald-50/80 p-3.5 text-center text-xs font-semibold text-emerald-700">
//           {resetSuccess}
//         </div>
//       )}
...
//         {/* Password Field (Only shown in Sign In mode) */}
//         {!isForgotPassword && (
//           <div>
...
//               setResetSuccess("");
//             }}
//             className="flex items-center justify-center gap-1.5 w-full pt-2 text-xs font-semibold text-slate-500 hover:text-slate-700 transition-colors"
//           >
